...
@section('content')
     <body>
    <h1 class="text-center mb-4 mt-5 ">Tambah Data pengunjung</h1>
    ...
    <div class="container mb-5">
        ...
        <div class="row justify-content-center">
           <div class="col-8">
                <div class="card">
                <div class="card-body">
                    <form action="/insertdatapengunjung" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">No KTP</label>
                            <input type="number" name="noktp" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                @error('noktp')
